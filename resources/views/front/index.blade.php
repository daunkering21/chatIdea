<div class="hero">
  <img src="{{ asset('assets/img/ChatIdea-2.png') }}" alt="logo" width="100px">
  <h1 class="hero-title">Made Chat Simple, Kept Private!</h1>
  <span class="hero-details">Connect instantly, chat securely, and keep your conversations truly private just for you!</span>
